...
Mobile.verifyElementVisible(findTestObject('Accounts/button_ADD ACCOUNT'), 0)

Mobile.tap(findTestObject('Accounts/button_ADD ACCOUNT'), 0)

Mobile.verifyElementVisible(findTestObject('Accounts/button_ADD'), 0)

Mobile.setText(findTestObject('Accounts/input_text_Account Name'), GlobalVariable.account1Name, 0)
...
Mobile.verifyElementText(findTestObject('Accounts/Acc Details/text_acc1_Account balance-colonSign- -dollarSign-1000.00'), 
    ('Account balance: $' + 1000) + '.00')

Mobile.verifyElementText(findTestObject('Accounts/Acc Details/text_acc1'), GlobalVariable.account1Name)
